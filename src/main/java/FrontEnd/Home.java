...
cl.show(mainPanel, "view");
    ...
    private void updatebtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updatebtnActionPerformed
        // TODO add your handling code here:
            ...
            SearchAndUpdate updatePanel = (SearchAndUpdate) Arrays.stream(mainPanel.getComponents())
    .filter(c -> c instanceof SearchAndUpdate)
    .findFirst().orElse(null);
if (updatePanel != null) updatePanel.initData();
cl.show(mainPanel, "update");
    ...
    private void deletebtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deletebtnActionPerformed
        // TODO add your handling code here:
            ...
            Delete deletePanel = (Delete) Arrays.stream(mainPanel.getComponents())
    .filter(c -> c instanceof Delete)
    .findFirst().orElse(null);
if ( deletePanel!= null) deletePanel.loadTable();
